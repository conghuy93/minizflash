...
class ESPWebFlasher {
    ...
    // Initialize firmware map with pre-encrypted URLs (obfuscated - no plain text)
    // URLs are XOR encrypted with random keys - GitHub URLs NEVER appear in source code
    // Attacker cannot find URLs by scanning JavaScript - must reverse engineer XOR algorithm
    initFirmwareMap() {
        // Pre-encrypted firmware URLs - Generated by generate_obfuscated_urls.py
        // Format: [base64_xor_encrypted_url, xor_key]
        // WARNING: DO NOT commit plain text URLs here!
        const obfuscated = {
            'fw1': ['ABkFFx1OWRkdFhJWDwQFDxsWA0UKBQYXBhkUCRpaFVkCWAYXBgoZEhdNRRkCHgsREgsdBh0cWVsOHgtXDgQDChkVBFNeWQcRBg==', 'hmqgntv6owex'],
            'fw2': ['Hx1FHBBbXF0QChpCEABFBBYDBgEHGQ4DGR1UAhdPEB0PRA4DGQ5ZGRpYQF0PAgMFDQ9dDRAJXB8DAgNDEQBDARQAARdQRQ8FGQ==', 'wi1lcasrbkml'],
            'fw3': ['Xw5MGAVTRVkGVUNYUBNMAAMLHwURRlcZWQ5dBgJHCRkZG1cZWR1QHQ9QWVkZXVofTRxUCQUBRRsVXVpZURNKBQEIGBNHGlYfWQ==', '7z8hvijvt44v'],
            'fw4': ['AQ4MBxoKXVVGV0BJDhMMHxxSBwlRRFQIBw4dGR0eERVZGVQIBx0QAhAJQVVZX1kOExwUFhpYXRdVX1lIDxMKGh5RAB8AGFUOBw==', 'izxwi0rz467g'],
            'fw5': ['DgEeSBVJQkJEAhxdARweUBMRGB5TEQgcCAEPVhJdDgJbTAgcCBICTR9KXkJbCgUaHBMGWRUbQgBXCgVcABwYVRESHwgDTQkaCA==', 'fuj8fsmm6cks']
        };
